...
import pdf from "../../assests/Manojupdate.pdf";
...
function Home({ colorName, theme }) {
  ...
  const LinkedInPath = () => {
    window.open("https://www.linkedin.com/in/manoj-h1222");
  };
          ...
          <div className="home-left" style={{ color: colorName }}>
            <div className="left-inside-home">
              ...
              <div
                ...
                data-aos-duration="1500"
              >
                <span className="k-text">M</span>anojkumar A{" "}
                <span
                  style={{
                    color: "#EF0107",
                    fontWeight: "bold",
              ...
              <div className="home-button">
                ...
                >
                  <button className="donwloadbutton">
                    <a href={pdf} download="manoj-resume.pdf" className="pdf">
                      Download CV
                    </a>
                  </button>
                </div>
          ...
          <div className="home-right">
            ...
            >
              ...
              <div className="happy-client-text">
                <div className="text-years">3+</div>
            ...
            >
              ...
              <div className="happy-client-text">
                <div className="text-years">5+</div>
                <div className="year-text">
                  Projects <br />
                  Completed
                </div>
            ...
            >
              ...
              <div className="happy-client-text">
                <div className="text-years">4+</div>
                <div className="year-text">
                  Happy
                  <br />
                  Clients
